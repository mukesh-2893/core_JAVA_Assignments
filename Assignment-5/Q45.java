...
class Q45{
    public static void main(String[] agrs){
        ...
        for(int i=0 ; i<arrCollegeStudent.length ; i++){
            System.out.print("\nRoll Number of Collage Student : ");
            int rollno =  sc.nextInt();
            System.out.print("Percentage of Collage Student : ");
            float percentage =  sc.nextFloat();
            System.out.print("Semester of Collage Student : ");
        ...
        for(int j=0 ; j<arrSchoolStudent.length ; j++){
            System.out.print("\nRoll Number of School Student : ");
            int rollno = sc.nextInt();
            System.out.print("Percentage of School Student : ");
            float percentage = sc.nextFloat();
            System.out.print("Class Name of School Student : ");
